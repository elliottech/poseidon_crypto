...
func TestBasicOps(t *testing.T) {
	...
	p0encoded, p1encoded, p2encoded, p3encoded, p4encoded, p5encoded, p6encoded, p7encoded := p0.Encode(), p1.Encode(), p2.Encode(), p3.Encode(), p4.Encode(), p5.Encode(), p6.Encode(), p7.Encode()
	...
	if !gFp5.Equals(&p0encoded, &vectors[0]) || !gFp5.Equals(&p1encoded, &vectors[1]) || !gFp5.Equals(&p2encoded, &vectors[2]) || !gFp5.Equals(&p3encoded, &vectors[3]) || !gFp5.Equals(&p4encoded, &vectors[4]) || !gFp5.Equals(&p5encoded, &vectors[5]) || !gFp5.Equals(&p6encoded, &vectors[6]) || !gFp5.Equals(&p7encoded, &vectors[7]) {
