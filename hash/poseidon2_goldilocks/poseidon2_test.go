...
func TestPermute(t *testing.T) {
	inp := [WIDTH]g.GoldilocksField{
		g.NewElement(5417613058500526590),
		g.NewElement(2481548824842427254),
		g.NewElement(6473243198879784792),
		g.NewElement(1720313757066167274),
		g.NewElement(2806320291675974571),
		g.NewElement(7407976414706455446),
		g.NewElement(1105257841424046885),
		g.NewElement(7613435757403328049),
		g.NewElement(3376066686066811538),
		g.NewElement(5888575799323675710),
		g.NewElement(6689309723188675948),
		g.NewElement(2468250420241012720),
	}

	Permute(&inp)

	expected := [WIDTH]g.GoldilocksField{
		g.NewElement(5364184781011389007),
		g.NewElement(15309475861242939136),
		g.NewElement(5983386513087443499),
		g.NewElement(886942118604446276),
		g.NewElement(14903657885227062600),
		g.NewElement(7742650891575941298),
		g.NewElement(1962182278500985790),
		g.NewElement(10213480816595178755),
		g.NewElement(3510799061817443836),
		g.NewElement(4610029967627506430),
		g.NewElement(7566382334276534836),
		g.NewElement(2288460879362380348),
	}
