...
func partialRounds(state *[WIDTH]g.GoldilocksField) {
	...
	for r := 0; r < ROUNDS_P; r++ {
		...
		// Summing in a tree structure
		r0 := AddUInt128(g.AsUInt128(s1), g.AsUInt128(s2))
		r1 := AddUInt128(g.AsUInt128(s3), g.AsUInt128(s4))
		r2 := AddUInt128(g.AsUInt128(s5), g.AsUInt128(s6))
		r3 := AddUInt128(g.AsUInt128(s7), g.AsUInt128(s8))
		r4 := AddUInt128(g.AsUInt128(s9), g.AsUInt128(s10))
		q0 := AddUInt128(r0, r1)
		q1 := AddUInt128(r2, r3)
