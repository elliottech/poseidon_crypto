...
func HashNoPad(input []g.Element) p2.HashOut {
...
func HashNToOne(input []p2.HashOut) p2.HashOut {
	if len(input) == 1 {
		return input[0]
	}
...
func HashTwoToOne(input1, input2 p2.HashOut) p2.HashOut {
	return HashNToHashNoPad([]g.Element{
